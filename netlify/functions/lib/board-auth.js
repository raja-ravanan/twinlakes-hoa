...
const PERMISSIONS = {
  ...
  getCommitteeVolunteers:            { access: "member", mutates: false },
  updateCommitteeVolunteerStatus:    { access: "member", mutates: true },
  updateCommitteeVolunteerNotes:     { access: "member", mutates: true },
  updateCommitteeVolunteerPublicListing: { access: "member", mutates: true },
